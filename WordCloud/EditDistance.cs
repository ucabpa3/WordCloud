...
namespace WordCloud {
    public class EditDistance {
        public static Dictionary<string, Dictionary<string, int>> ComputeALLLevenshtein(List<string> words) {
        ...
        public static Dictionary<string, int> ComputeLevenshtein(string givenWord, List<string> words) {
            Dictionary<string, int> dists = new Dictionary<string, int>();
